...
public interface Configuration {
    ...
    default <T> List<T> getList(Field field, Function<String, T> converter) {
        return getList(field.name(), converter);
    }

    default <T> List<T> getList(String key, Function<String, T> converter) {
