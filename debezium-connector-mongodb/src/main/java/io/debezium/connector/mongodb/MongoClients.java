...
public class MongoClients {
    ...
    public MongoClient clientFor(ConnectionString connectionString) {
        ...
        return connection(settings.build());
    }

    public MongoClient clientFor(ConnectionString connectionString, ReplicaSet replicaSet, ReadPreference preference) {
        MongoClientSettings.Builder settings = settings()
                .applyConnectionString(connectionString)
                .readPreference(preference)
                .applyToClusterSettings(builder -> builder.requiredReplicaSetName(replicaSet.replicaSetName()));
